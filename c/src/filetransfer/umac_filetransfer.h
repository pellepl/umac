...
typedef struct umft_stream_s {
  ...
  /** If returning zero, the received data is considered written, else not */
...
typedef void (* umft_request_call_fn)(struct umft_s *uft, umtick delta);
